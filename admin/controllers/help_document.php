 ...
 */
class DemoControllerHelp_document extends JControllerForm
{
	/**
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('help_document.edit', 'com_demo.help_document.' . (int) $recordId);
			if (!$permission && !is_null($permission))
			{
				if ($user->authorise('help_document.edit.own', 'com_demo.help_document.' . $recordId))
				{
					...
					if ($ownerId == $user->id)
					{
						if ($user->authorise('help_document.edit.own', 'com_demo'))
						{
							return true;
						}
					}
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_demo&view=help_documents' . $this->getRedirectToListAppend(), false));
